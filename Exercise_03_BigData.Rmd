...
```{r}
phenocam = readr::read_csv("https://data.ecoforecast.org/neon4cast-targets/phenology/phenology-targets.csv.gz",skip = 11)
time = as.Date(phenocam$Date)
plot(phenocam$Date, phenocam, type='l')
```
