...
According to Table 1, the initial condition uncertainty should change exponentially. Our graph does not do that as it is relatively limited to an N value of 500.
