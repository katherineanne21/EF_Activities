...
```{r}
gflu_new = gflu
NA_vector = rep(NA, nrow(gflu))
indices_to_convert <- seq(1, length(gflu), by = 4)
gflu_new$Massachusetts <- NA_vector
gflu_new$Massachusetts[indices_to_convert] <- gflu[indices_to_convert, "Massachusetts"]
y_new = gflu_new$Massachusetts
