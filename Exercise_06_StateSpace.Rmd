...
Process error (tau_add) SD = (first) 26.216989 (second)
Observation error (tau_obs) SD = (first) 233.962712 (second)
...
A decrease in process error means that the model improved.
